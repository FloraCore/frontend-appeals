...
import {checkPunish} from "@/services/litebansService";

import type {RcFile} from 'antd/es/upload';
import type {UploadFile} from 'antd/es/upload/interface';
import {addAppeal, checkBlacklist} from "@/services/appealService";
        ...
        <StepsForm<{
            ...
            onFinish={async () => {
                ...
                try {
                    ...
                    const {data} = await addAppeal({...params})
